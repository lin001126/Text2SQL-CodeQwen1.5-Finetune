...
if __name__ == "__main__":
    ...
    if args.natsql:
        ...
        args.gold = "eval/eval_data/gold_natsql2sql.txt"
        args.table = "eval/eval_data/tables_for_natsql2sql.json"
    else:
        output_file_path = args.input
        # args.gold = "./eval/data/gold.txt"
        args.gold = "eval/eval_data/gold.txt"
        args.table = "eval/eval_data/tables.json"
